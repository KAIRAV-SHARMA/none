...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(600,displayHeight-543,40,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(600,displayHeight-315,10,40);
    //obstacle.debug = true;
...
function bid(){
    ...
    if (frameCount % 99 === 0){
      var bird = createSprite(615,displayHeight-325,20,20);
...
function bom (){
  if (score>6){
    if(frameCount%599==0){
      var bomb = createSprite(500,displayHeight-390 )
